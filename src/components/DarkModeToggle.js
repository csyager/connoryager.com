...
export default function DarkModeToggle() {
    ...
    useEffect(() => {
        if (localStorage.getItem(localStorageKey)) {
            console.log("setting present in local storage");
            setDarkMode(localStorage.getItem(localStorageKey) === "true");
    ...
    const setDarkModeInLocalStorage = (darkMode) => {
